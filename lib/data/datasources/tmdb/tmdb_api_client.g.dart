...
class _TmdbApiClient implements TmdbApiClient {
  ...
  Future<TmdbResponse> getPopularMovies(String token, {int page = 1}) async {
    ...
    final _options = _setStreamType<TmdbResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/movie/popular?language=fr-FR',
    ...
    late TmdbResponse _value;
    try {
      _value = TmdbResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<TmdbMovieModel> getMovieDetails(String token, String movieId) async {
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TmdbMovieModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TmdbMovieModel _value;
    try {
      _value = TmdbMovieModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
